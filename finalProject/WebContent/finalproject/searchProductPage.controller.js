...
//	},
	...
	onSearchProduct:function(oEvt){
		...
		if(sProduct !== undefined || sProduct !== ""){
			...
			var sUrl = "https://cors-anywhere.herokuapp.com/http://services.odata.org/V3/OData/OData.svc/Products?$filter=substringof('"+sProduct+"', Name) eq true&$format=json";
	...
	onProductListPress : function(oEvt){
		...
		var sUrl = "https://cors-anywhere.herokuapp.com/http://services.odata.org/V3/OData/OData.svc/Products?$filter=substringof('"+sProductPress+"', Name) eq true&$format=json";
		var oModel = new sap.ui.model.json.JSONModel(sUrl);
		//Getting the Data and putting in list model
